...
// 3-td version import {ReactComponent as CartIcon }from "../../assets/CartIcon.svg";
...
const HeaderCart = (props) => {
  const {onShow}=useContext(ModalContex)
  ...
  return (
    <button onClick={onShow} className={classes.button}>
      <span className={classes.icon}>
        ...
        {/* 2-nd version <img src={CartIcon} alt="icon" /> */}
        {/* 3-rd version  <CartIcon/> */}
        <CartIcon/>
      </span>
      <span >Your cart</span>
